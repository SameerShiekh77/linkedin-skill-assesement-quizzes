...
#### Q21. How would you mark up a header for a table row?
...
#### Q25. A designer gave you CSS code that should run only when the device rendering the page is in dark mode. How would you embed that code?
